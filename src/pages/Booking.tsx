        ...
        <div className="container">
          ...
          {!user ? (
            <div className="bg-white p-6 rounded-xl shadow-sm text-center">
              ...
              <p className="text-gray-600">Please sign in to access the Booking system.</p>
            </div>
          ) : (
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <p className="text-gray-600">Booking system functionality will be implemented soon.</p>
            </div>
          )}
        </div>
      </main>
